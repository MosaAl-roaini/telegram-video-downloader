...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("👋 أهلاً بك في بوت تحميل الفيديوهات.\n\n📎 أرسل رابط فيديو وسأحاول تحميله لك.")
...
def main():
    if not BOT_TOKEN or BOT_TOKEN == "PASTE_NEW_TOKEN_HERE":
        raise RuntimeError("ضع BOT_TOKEN الجديد في ملف .env ثم أعد تشغيل البوت.")
